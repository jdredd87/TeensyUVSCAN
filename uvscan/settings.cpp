...
void loadConfiguration() {
  ...
  File file1 = configfs.open(cfgfilename);
...
void saveConfiguration() {
  configfs.remove(cfgfilename);

  File file1 = configfs.open(cfgfilename, FILE_WRITE);
  if (!file1) {
    Serial.println("");
...
void loadPIDSfile() {
  ...
  pidCounter = 0;
  File file1 = configfs.open(pidsfilename);
...
void savePIDSfile() {
  configfs.remove(pidsfilename);

  File file1 = configfs.open(pidsfilename, FILE_WRITE);
